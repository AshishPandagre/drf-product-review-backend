...
# If we need a product list response with category, comments and sites (with product size and company) and we dont need a product content field. And category id must be 4. we can do :
# 	/product/?expand=category,comments,sites.company,sites.productsize&omit=content&category=4
